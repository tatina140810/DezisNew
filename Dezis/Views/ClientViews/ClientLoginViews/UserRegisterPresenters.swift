...
class UserRegisterPresenters: IUserRegisterPresenters {
    ...
    private var view: INewUserRegisterViewController?
    private var secondView: IUserRegisterSecondPageViewController?
    
    private var userInfo: (username: String, email: String, password: String, adress: String, apartmentNumber: String) = ("", "", "", "", "")
